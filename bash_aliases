...
alias glp="git log --pretty=fuller -3"
alias gr="grep --exclude=*.swp --exclude-dir=.git --color=auto -r "
...
alias git-stealth-rebase="git -c rebase.instructionFormat='%s%nexec GIT_COMMITTER_DATE="%cD" git commit --amend --no-edit --date="%cD"' rebase -i "
alias sudo="sudo "
